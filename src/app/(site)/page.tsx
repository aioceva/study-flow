      ...
      <section className="px-5 py-10">
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <div style={{ position: "relative", paddingLeft: 19 }}>
            ...
            <p style={{ ...P, margin: "0 0 14px" }}>
              Така в началото на 2026 се появи Study Flow. В момента развиваме приложението и го тестваме с малък брой семейства.
            </p>
            <p style={{ ...P, margin: 0 }}>
              Ако темата ви е близка и искате да се включите като родител, специалист по работа с деца с дислексия, UX специалист или просто човек с интерес към ученето, ще се радвам да се свържем.
            </p>
          </div>
